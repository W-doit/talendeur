...
const PrivacyPolicy: React.FC = () => (
  <div className="max-w-3xl mx-auto py-12 px-4 text-gray-800 relative">
    ...
    <div className="space-y-6">
      ...
      <p>This Privacy Policy, posted on our Website, sets forth the general rules and policies governing your use of our Website. Depending on your activities when visiting our Website, you may be required to agree to additional terms and conditions.</p>
      ...
      <p>Talendeur Ltd may collect statistics about the behaviour of visitors to its website. Talendeur Ltd may display this information publicly or provide it to others. However, Talendeur Ltd does not disclose your personally-identifying information.</p>
